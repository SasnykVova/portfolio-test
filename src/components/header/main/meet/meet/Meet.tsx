    ...
    return (
        ...
        <section className={style.greetSection}>
            <div className={style.greetingBlock}>
                ...
                <div className={style.text}>Lorem ipsum dolor sit amet consectetur. 
                    Imperdiet convallis blandit felis ligula aliquam venenatis nisi ante. Aliquet ornare tellus consectetur lacus</div>
